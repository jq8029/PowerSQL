...
public class H2Data extends DatabaseData {
	...
	public String getColumnSQL(Info info) {
		return "SELECT TABLE_CATALOG, TABLE_SCHEMA, TABLE_NAME, COLUMN_NAME, DATA_TYPE as TYPE_NAME, ORDINAL_POSITION, IS_NULLABLE, CHARACTER_MAXIMUM_LENGTH as MAX_LENGTH, NUMERIC_PRECISION as NUM_LENGTH, NUMERIC_SCALE as NUM_SCALE, COLUMN_DEFAULT as COL_DEFAULT FROM information_schema.COLUMNS where TABLE_SCHEMA='"
