...
public class Constants {
	...
	public static final String FILE_DB = "data" + FILE_SEPERATOR + "dbinfo.txt";
	public static final String FILE_CACHE = "data" + FILE_SEPERATOR + "cache";
	...
	public static String TITLE_COLUMN = "Column";
	...
	public static String MSG_FAIL_CRT_COL_NAME = "Failed to create column.";
